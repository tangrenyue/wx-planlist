...
var constantApi = require("../../utils/postalCodedata.js");
Page({
  ...
  onLoad: function (options) {
    var that = this;
    var url = constantApi.mobApi.getAllCity();
  ...
  queryCityClick: function () {
    ...
    if (tabsPosition == 0) { //城市查邮编
      ...
      let url = constantApi.mobApi.queryCityCode(provId, cityId, areaId);
      ...
      let url1 = constantApi.mobApi.codeToQuery(postNumInputStr);
